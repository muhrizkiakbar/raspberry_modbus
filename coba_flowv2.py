...
instrument = minimalmodbus.Instrument("/dev/ttyUSB2", 1)
...
def set_section_config():
    ...
    try:
        ...
        instrument.write_register(1043, 1850, functioncode=6)

        # Size2 = lebar slope = 1000 mm
        # instrument.write_register(1044, 1000, functioncode=6)
        instrument.write_register(1044, 3000, functioncode=6)

        # Size3 = lebar dasar = 9600 mm
        instrument.write_register(1045, 7000, functioncode=6)
        ...
        instrument.write_register(1058, 2500, functioncode=6)
