                    ...
                    for sensor in device["sensors"]:
                        ...
                        if value is not None:
                            ...
                            if sensor["name"] == "Instantaneous Flow":
                                ...
                                # 65000 angka tinggi  maksimal
                                # 4000 = tinggi penampan dan tinggi letak sensor
                                payload_api["water_height"] = 4000 - (65000 - value)
                                sensor_data["value"] = 4000 - (65000 - value)
...
if __name__ == "__main__":
    gateway = IndustrialGateway("sensors_config_water_level.json")
